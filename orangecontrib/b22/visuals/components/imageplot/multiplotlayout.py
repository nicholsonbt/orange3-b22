...
from orangecontrib.b22.visuals.components.imageplot.multiimage import MultiImage
from orangecontrib.b22.visuals.components.imageplot.multilegend import MultiLegend
